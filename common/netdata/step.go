...
func (ss *SingleStep) Write(out *DataOutputX) {
	out.WriteDecimal32(ss.Parent)
	out.WriteDecimal32(ss.Index)
	out.WriteDecimal32(ss.StartTime)
	out.WriteDecimal32(0)
}

func (ss *SingleStep) Read(in *DataInputX) Step {
